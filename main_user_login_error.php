...
<div id="wrapper2">
	<div id="welcome" class="container">
		<div class="title">
			<h2><img src="User-icon.png" width="166" height="164" alt="" /></font></p>
			  <p><font color="white" size="16" face="Forte">::User Login:: </font></p>
			</h2>
		</div>
...
<div id="wrapper3">
<form id="form1" name="form1" method="post" action="user_login_process.php" >
<p align="center">&nbsp;</p>
<p align="center"><font color="red">ERROR LOGIN,INVALID USER ID OR MISSMATCH PASSWORD</font></p>
