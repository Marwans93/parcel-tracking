...
<p>
<h1>USER LIST</h1>
<p><font color="#FF0000">USER DELETED!</font></p>
...
<?php
    ...
    <tbody>
    	...
    	<tr>
            ...
            <td align="center"><a href="admin_user_edit.php?$a=<?php echo $r['cust_email']?>"" class="ask">Edit
            <img src="images/user_edit.png" alt="" width="40" height="39" title="" border="0" />            &nbsp;&nbsp;&nbsp;</a></td>
            <td><a href="admin_parcel_list_delete_process.php?$a=<?php echo $r['cust_email']?>" >Delete&nbsp;&nbsp;&nbsp;<img src="images/trash.png" alt="" width="35" height="38" title="" border="0" /></a></td>
        </tr>
        <?php 
			}
		?>       
