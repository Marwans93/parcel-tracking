...
<p>
<h1>PARCEL LIST</h1>
<p><Font color="#FF0000">PARCEL UPDATED!</Font></p>
<table summary="2007 Major IT Companies' Profit" bordercolor="#000000" border="4" >
    <thead>
    	<tr bordercolor="#000000">
        	<th width="20" scope="col"></th>
            <th width="109" scope="col" >&nbsp;&nbsp;&nbsp;<h2>Parcel Id</h2>&nbsp;&nbsp;&nbsp;</th>

            <th width="181" class="rounded" scope="col">&nbsp;&nbsp;&nbsp;<h2>Shipping Status</h2>&nbsp;&nbsp;&nbsp;</th>
            <th width="84" class="rounded" scope="col">&nbsp;&nbsp;&nbsp;<h2>Edit</h2>&nbsp;&nbsp;&nbsp;</th>
          <th width="66" class="rounded-q4" scope="col">&nbsp;&nbsp;&nbsp;<h2>Delete</h2>&nbsp;&nbsp;&nbsp;</th>
        </tr>
    </thead>
    
<?php
   
			$s = "select * from parcel";
	  ...
	  $t = mysql_query($shipping) or die (mysql_error());
			...
			while($r = mysql_fetch_array($q) && $y = mysql_fetch_array($t))
			{
				$count++;
    ...
    <tbody>
    	...
    	<tr>
        	<td></td>
            <td align="center"><?php echo $y['parcel_id']; ?></td>
			<td align="center"><?php echo $y['shipping_status']; ?> </td>
            <td align="center"><a href="admin_form_edit.php?$a=<?php echo $y['parcel_id']?>"" class="ask">Edit
            <img src="images/user_edit.png" alt="" width="40" height="39" title="" border="0" />            &nbsp;&nbsp;&nbsp;</a></td>
            <td><a href="admin_parcel_list_delete_process.php?$a=<?php echo $y['parcel_id']?>" >Delete&nbsp;&nbsp;&nbsp;<img src="images/trash.png" alt="" width="35" height="38" title="" border="0" /></a></td>
        </tr>
        <?php 
			}
		?>       
