...
<div id="wrapper2">
	<div id="welcome" class="container">
		<div class="title">
			<p><font color="white" size="16" face="Forte"><img src="admin icon.jpg" width="169" height="140" alt="" /></font></p>
			  <p><font color="white" size="16" face="Forte">::Admin Login:: </font></p>
		</div>
		
	</div>
</div>
<div id="wrapper3">
<form id="form1" name="form1" method="post" action="admin_login_process.php" >
  <p align="center">&nbsp;</p>
<p align="center"><font color="red">ERROR LOGIN,INVALID ADMIN ID OR MISSMATCH PASSWORD</font></p>
  <p align="center">ID (E-mail):
    <label for="username2"></label>
    <input type="text" name="admin_id" id="admin_id" />
  <font color="red">[eg : user93@yahoo.com]</font></p>
  <p align="center">PASSWORD :
    <label for="password2"></label>
    <input type="password" name="admin_psw" id="admin_psw" />
